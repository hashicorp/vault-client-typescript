...
export interface PkiRevokeIssuerResponse {
    ...
    /**
     * Whether critical extension checks should be performed when issuing certificates. (Enterprise only); over-ridden to be false in common criteria mode.
     * @type {boolean}
     * @memberof PkiRevokeIssuerResponse
     */
    disable_critical_extension_checks?: boolean;
    /**
     * Whether the issuer name check should be performed when issuing certificates. (Enterprise only); over-ridden to be false in common criteria mode
     * @type {boolean}
     * @memberof PkiRevokeIssuerResponse
     */
    disable_name_checks?: boolean;
    /**
     * Whether name constraint checks should be performed when issuing certificates. (Enterprise only); over-ridden to be false in common criteria mode.
     * @type {boolean}
     * @memberof PkiRevokeIssuerResponse
     */
    disable_name_constraint_checks?: boolean;
    /**
     * Whether max path length checks should be performed when issuing certificates. (Enterprise only); over-ridden to be false in common criteria mode.
     * @type {boolean}
     * @memberof PkiRevokeIssuerResponse
     */
    ...
    /**
     * Whether the issuer time check should be performed when issuing certificates. (Enterprise only); over-ridden to be true in common criteria mode.
     * @type {boolean}
     * @memberof PkiRevokeIssuerResponse
     */
    enable_time_checks?: boolean;
    /**
     * Issuer Id
     * @type {string}
     * @memberof PkiRevokeIssuerResponse
...
export function PkiRevokeIssuerResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PkiRevokeIssuerResponse {
    ...
    return {
        ...
        'enable_time_checks': json['enable_time_checks'] == null ? undefined : json['enable_time_checks'],
...
export function PkiRevokeIssuerResponseToJSONTyped(value?: PkiRevokeIssuerResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'enable_time_checks': value['enable_time_checks'],
