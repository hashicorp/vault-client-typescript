...
export interface SshWriteRoleRequest {
     ...
     */
    algorithm_signer?: SshWriteRoleRequestAlgorithmSignerEnum;
    /**
     ...
     * @memberof SshWriteRoleRequest
     */
    key_type?: SshWriteRoleRequestKeyTypeEnum;
    /**
...
export function SshWriteRoleRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SshWriteRoleRequest {
    ...
    return {
        ...
        'algorithm_signer': json['algorithm_signer'] == null ? undefined : json['algorithm_signer'],
        'allow_bare_domains': json['allow_bare_domains'] == null ? undefined : json['allow_bare_domains'],
        'allow_empty_principals': json['allow_empty_principals'] == null ? undefined : json['allow_empty_principals'],
        'allow_host_certificates': json['allow_host_certificates'] == null ? undefined : json['allow_host_certificates'],
        'allow_subdomains': json['allow_subdomains'] == null ? undefined : json['allow_subdomains'],
        'allow_user_certificates': json['allow_user_certificates'] == null ? undefined : json['allow_user_certificates'],
        'allow_user_key_ids': json['allow_user_key_ids'] == null ? undefined : json['allow_user_key_ids'],
        'allowed_critical_options': json['allowed_critical_options'] == null ? undefined : json['allowed_critical_options'],
        ...
        'allowed_extensions': json['allowed_extensions'] == null ? undefined : json['allowed_extensions'],
        'allowed_user_key_lengths': json['allowed_user_key_lengths'] == null ? undefined : json['allowed_user_key_lengths'],
        'allowed_users': json['allowed_users'] == null ? undefined : json['allowed_users'],
        'allowed_users_template': json['allowed_users_template'] == null ? undefined : json['allowed_users_template'],
        'cidr_list': json['cidr_list'] == null ? undefined : json['cidr_list'],
        'default_critical_options': json['default_critical_options'] == null ? undefined : json['default_critical_options'],
        'default_extensions': json['default_extensions'] == null ? undefined : json['default_extensions'],
        'default_extensions_template': json['default_extensions_template'] == null ? undefined : json['default_extensions_template'],
        'default_user': json['default_user'] == null ? undefined : json['default_user'],
        'default_user_template': json['default_user_template'] == null ? undefined : json['default_user_template'],
        'exclude_cidr_list': json['exclude_cidr_list'] == null ? undefined : json['exclude_cidr_list'],
        'key_id_format': json['key_id_format'] == null ? undefined : json['key_id_format'],
...
export function SshWriteRoleRequestToJSONTyped(value?: SshWriteRoleRequest | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'algorithm_signer': value['algorithm_signer'],
        'allow_bare_domains': value['allow_bare_domains'],
        'allow_empty_principals': value['allow_empty_principals'],
        'allow_host_certificates': value['allow_host_certificates'],
        'allow_subdomains': value['allow_subdomains'],
        'allow_user_certificates': value['allow_user_certificates'],
        'allow_user_key_ids': value['allow_user_key_ids'],
        'allowed_critical_options': value['allowed_critical_options'],
        ...
        'allowed_user_key_lengths': value['allowed_user_key_lengths'],
        'allowed_users': value['allowed_users'],
        'allowed_users_template': value['allowed_users_template'],
        'cidr_list': value['cidr_list'],
        'default_critical_options': value['default_critical_options'],
        'default_extensions': value['default_extensions'],
        'default_extensions_template': value['default_extensions_template'],
        'default_user': value['default_user'],
        'default_user_template': value['default_user_template'],
        'exclude_cidr_list': value['exclude_cidr_list'],
        'key_id_format': value['key_id_format'],
