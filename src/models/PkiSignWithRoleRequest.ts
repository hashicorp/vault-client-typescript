...
export interface PkiSignWithRoleRequest {
     ...
     * @memberof PkiSignWithRoleRequest
     */
    pkcs12_encoder?: PkiSignWithRoleRequestPkcs12EncoderEnum;
    /**
     ...
     * @memberof PkiSignWithRoleRequest
     */
    private_key_format?: PkiSignWithRoleRequestPrivateKeyFormatEnum;
    /**
...
* @enum {string}
*/
export enum PkiSignWithRoleRequestPkcs12EncoderEnum {
