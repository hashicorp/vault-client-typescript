...
export interface PkiConfigureAcmeRequest {
    ...
    /**
     * List of CIDR blocks that are excluded from ACME challenge validation. IPs within these ranges will be rejected for validation. Can be individual IPs or CIDR notation. This list takes precedence over challenge_permitted_ip_ranges.
     * @type {Array<string>}
     * @memberof PkiConfigureAcmeRequest
     */
    challenge_excluded_ip_ranges?: Array<string>;
    /**
     * List of CIDR blocks that are permitted for ACME challenge validation. If set, only IPs within these ranges will be allowed for validation. Can be individual IPs or CIDR notation.
     * @type {Array<string>}
     * @memberof PkiConfigureAcmeRequest
     */
    challenge_permitted_ip_ranges?: Array<string>;
    /**
...
export function PkiConfigureAcmeRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PkiConfigureAcmeRequest {
    ...
    return {
        ...
        'challenge_excluded_ip_ranges': json['challenge_excluded_ip_ranges'] == null ? undefined : json['challenge_excluded_ip_ranges'],
        'challenge_permitted_ip_ranges': json['challenge_permitted_ip_ranges'] == null ? undefined : json['challenge_permitted_ip_ranges'],
...
export function PkiConfigureAcmeRequestToJSONTyped(value?: PkiConfigureAcmeRequest | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'challenge_excluded_ip_ranges': value['challenge_excluded_ip_ranges'],
        'challenge_permitted_ip_ranges': value['challenge_permitted_ip_ranges'],
