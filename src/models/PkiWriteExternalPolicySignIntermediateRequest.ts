...
export interface PkiWriteExternalPolicySignIntermediateRequest {
     ...
     * @memberof PkiWriteExternalPolicySignIntermediateRequest
     */
    pkcs12_encoder?: PkiWriteExternalPolicySignIntermediateRequestPkcs12EncoderEnum;
    /**
...
* @enum {string}
*/
export enum PkiWriteExternalPolicySignIntermediateRequestPkcs12EncoderEnum {
